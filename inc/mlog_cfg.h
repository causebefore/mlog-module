...
/* 使能输出日志 */
#define MLOG_OUTPUT_ENABLE
/* 设置静态输出日志级别。范围：从 MLOG_LVL_ASSERT 到 MLOG_LVL_VERBOSE */
#define MLOG_OUTPUT_LVL MLOG_LVL_VERBOSE
/* 使能断言检查 */
#define MLOG_ASSERT_ENABLE
/* 每行日志的缓冲区大小 */
#define MLOG_LINE_BUF_SIZE 1024
/* 每行日志的行号最大长度 */
#define MLOG_LINE_NUM_MAX_LEN 5
/* 输出过滤器的标签最大长度 */
#define MLOG_FILTER_TAG_MAX_LEN 15
/* 输出过滤器的关键字最大长度 */
#define MLOG_FILTER_KW_MAX_LEN 16
/* 输出过滤器的标签级别最大数量 */
#define MLOG_FILTER_TAG_LVL_MAX_NUM 5
/* 输出换行符 */
